...
public class AbstractCOSClientTest {
    ...
    protected static void putObjectFromLocalFile(File localFile, String key) {
        ...
        UinGrantee uinGrantee = new UinGrantee();
        uinGrantee.setIdentifier("734000014");
    ...
    // 流式上传
    protected static void putObjectFromLocalFileByInputStream(File localFile,
                                                     long uploadSize,
                                                     String uploadEtag,
                                                     String key) {
        assertNotNull(cosclient);
    ...
    protected static void headSimpleObject(String key, long expectedLength, String expectedEtag) {
    ...
    protected static void headMultiPartObject(String key, long expectedLength, int expectedPartNum) {
        ObjectMetadata objectMetadata =
                cosclient.getObjectMetadata(new GetObjectMetadataRequest(bucket, key));
        assertEquals(expectedLength, objectMetadata.getContentLength());
