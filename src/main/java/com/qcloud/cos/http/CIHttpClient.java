...
public class CIHttpClient implements CosHttpClient {

    private CIClientConfig clientConfig;
    ...
    private static final Logger log = LoggerFactory.getLogger(CIHttpClient.class);

    public CIHttpClient(CIClientConfig clientConfig) {
        super();
    ...
    private <X extends CosServiceRequest> CosServiceException handlerErrorMessage(
            ...
            final HttpResponse apacheHttpResponse) throws IOException {
