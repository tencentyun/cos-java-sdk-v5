...
public class COSClient implements COS , CI {
    ...
    public COSClient(COSCredentials cred, CIClientConfig clientConfig) {
        this(new COSStaticCredentialsProvider(cred), clientConfig);
    }

    public COSClient(COSCredentialsProvider credProvider, CIClientConfig clientConfig) {
        super();
        this.credProvider = credProvider;
        this.clientConfig = clientConfig;
        this.cosHttpClient = new CIHttpClient(clientConfig);
    }
    ...
    protected void setHttpRequestContent(CosHttpRequest httpRequest, CIServiceRequest serviceRequest) throws UnsupportedEncodingException {
        byte[] content = convertToXmlByteArray(serviceRequest);
    ...
    private byte[] convertToXmlByteArray(Object request) throws UnsupportedEncodingException {
    ...
    @Override
    public MediaJobResponse createMediaJobs(MediaJobObject req) throws UnsupportedEncodingException {
        CosHttpRequest<MediaJobObject> request = createRequest(req.getBucketName(), "/jobs", req, HttpMethodName.POST);
        this.setHttpRequestContent(request, req);
    ...
    public MediaListJobResponse describeMediaJobs(MediaJobsRequest mediaJobsRequest) {
        CosHttpRequest<MediaJobsRequest> request = createRequest(mediaJobsRequest.getBucketName(), "/jobs", mediaJobsRequest, HttpMethodName.GET);
        addParameterIfNotNull(request, "queueId", mediaJobsRequest.getQueueId());
        addParameterIfNotNull(request, "tag", mediaJobsRequest.getTag());
        addParameterIfNotNull(request, "orderByTime", mediaJobsRequest.getOrderByTime());
        addParameterIfNotNull(request, "nextToken", mediaJobsRequest.getNextToken());
        addParameterIfNotNull(request, "size", mediaJobsRequest.getSize().toString());
        addParameterIfNotNull(request, "states", mediaJobsRequest.getStates());
        addParameterIfNotNull(request, "startCreationTime", mediaJobsRequest.getStartCreationTime());
        addParameterIfNotNull(request, "endCreationTime", mediaJobsRequest.getEndCreationTime());
    ...
    public MediaListQueueResponse describeMediaQueues(MediaQueueRequest mediaQueueRequest) {
        CosHttpRequest<MediaQueueRequest> request = createRequest(mediaQueueRequest.getBucketName(), "/queue", mediaQueueRequest, HttpMethodName.GET);
        addParameterIfNotNull(request, "queueIds", mediaQueueRequest.getQueueId());
        addParameterIfNotNull(request, "state", mediaQueueRequest.getState());
        addParameterIfNotNull(request, "pageNumber", mediaQueueRequest.getPageNumber());
        addParameterIfNotNull(request, "pageSize", mediaQueueRequest.getPageSize());
        return invoke(request, new Unmarshallers.ListQueueUnmarshaller());
    }

    @Override
    public MediaQueueResponse updateMediaQueue(MediaQueueRequest mediaQueueRequest) throws UnsupportedEncodingException {
        ...
        this.setHttpRequestContent(request, mediaQueueRequest);
    ...
    @Override
    public MediaTemplateResponse createMediaTemplate(MediaTemplateRequest templateRequest) throws UnsupportedEncodingException {
        ...
        this.setHttpRequestContent(request, templateRequest);
    ...
    @Override
    public Boolean updateMediaTemplate(MediaTemplateRequest request) throws UnsupportedEncodingException {
        ...
        this.setHttpRequestContent(httpRequest, request);
        this.invoke(httpRequest, voidCosResponseHandler);
        return true;
    }

    @Override
    public SnapshotResponse generateSnapshot(SnapshotRequest request) throws UnsupportedEncodingException {
    ...
    @Override
    public MediaInfoResponse generateMediainfo(MediaInfoRequest request) throws UnsupportedEncodingException {
    ...
    @Override
    public Boolean deleteWorkflow(MediaWorkflowRequest request) {
        rejectNull(request.getWorkflowId(), "The request parameter must be specified when delete the object tags");
        CosHttpRequest<MediaWorkflowRequest> httpRequest = this.createRequest(request.getBucketName(), "/workflow/" + request.getWorkflowId(), request, HttpMethodName.DELETE);
        this.invoke(httpRequest, voidCosResponseHandler);
        return true;
    }

    @Override
    public MediaWorkflowResponse describeWorkflow(MediaWorkflowRequest request) {
        CosHttpRequest<MediaWorkflowRequest> httpRequest = this.createRequest(request.getBucketName(), "/workflow", request, HttpMethodName.GET);
        addParameterIfNotNull(httpRequest, "ids", request.getIds());
        addParameterIfNotNull(httpRequest, "name", request.getName());
        addParameterIfNotNull(httpRequest, "pageNumber", request.getPageNumber());
        addParameterIfNotNull(httpRequest, "pageSize", request.getPageSize());
        return this.invoke(httpRequest, new Unmarshallers.WorkflowUnmarshaller());
    }

    @Override
    public MediaWorkflowExecutionResponse describeWorkflowExecution(MediaWorkflowRequest request) {
        CosHttpRequest<MediaWorkflowRequest> httpRequest = this.createRequest(request.getBucketName(), "/workflowexecution/" + request.getRunId(), request, HttpMethodName.GET);
        return this.invoke(httpRequest, new Unmarshallers.WorkflowExecutionUnmarshaller());
    }

    @Override
    public MediaWorkflowExecutionsResponse describeWorkflowExecutions(MediaWorkflowRequest request) {
        CosHttpRequest<MediaWorkflowRequest> httpRequest = this.createRequest(request.getBucketName(), "/workflowexecution", request, HttpMethodName.GET);
